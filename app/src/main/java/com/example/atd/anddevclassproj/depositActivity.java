...
public class depositActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Bank - Deposit");
    ...
    // This method will be called when the user clicks the send deposit button
    ...
    public void onClickSendDeposit(View view) {
        ...
        StorageReference depositStorageRef = mStorageRef.child("Deposit/depositImage " + currentDateTimeString + ".jpg");

        // Attempt to send the file to Firebase
        depositStorageRef.putFile(file)
    ...
    public void SendNotificationWithPicture() {
        ...
        String title = "Deposit Made";
        String body = "Deposit Made";

        // Get the image we want to display
        Bitmap depositBitmap = BitmapFactory.decodeFile(imgDecodeString);
